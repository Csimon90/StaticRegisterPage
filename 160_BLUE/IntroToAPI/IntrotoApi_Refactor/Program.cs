...
Vehicles vehicle = await _service.GetVehicleAsync("https://swapi.dev/api/vehicles/14");
...
System.Console.WriteLine(vehicle.Vehicle);

SearchResults<Person> personSearchResult = await _service.GetSearchPersonAsync("skywalker");
foreach (var p in  personSearchResult.Result)
{
